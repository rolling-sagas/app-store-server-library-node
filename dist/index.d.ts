...
export declare class AppStoreServerAPIClient {
    ...
    private static LOCAL_TESTING_URL;
    ...
    protected makeFetchRequest(path: string, parsedQueryParameters: URLSearchParams, method: string, stringBody: string | undefined, headers: {
        [key: string]: string;
     ...
     */
    getTransactionHistory(transactionId: string, revision: string | null, transactionHistoryRequest: TransactionHistoryRequest, version?: GetTransactionHistoryVersion): Promise<HistoryResponse>;
    /**
...
export declare class APIException extends Error {
    ...
    apiError: number | APIError | null;
    errorMessage: string | null;
    constructor(httpStatusCode: number, apiError?: number | null, errorMessage?: string | null);
}
/**
...
export declare enum GetTransactionHistoryVersion {
    /**
     * @deprecated
     */
    V1 = "v1",
